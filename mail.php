...
$crlf = "\r\n";
$message_txt = "Pour réinitialiser votre mot de passe, merci de vous rendre sur ce lien http://localhost/projet2-wf3/reset2.php?key=" . $key[0] . "";  // contenu du mail en texte simple
$message_html = "<html>Pour réinitialiser votre mot de passe, merci de vous rendre sur ce lien http://localhost/projet2-wf3/reset2.php?key=" . $key[0] . "</html>"; // contenu du mail en html
$boundary = "-----=".md5(rand());
